...
// 中间件 redux-promise-middleware 用于增强dispatch，可以传入 promise 对象
// 同时可发送三个action， _PENDING / _FULFILLED / _REJECTED
...
const createStoreWithMiddleware = applyMiddleware(httpRequest, thunk, promiseMiddleware(), promise, logger)(createStore);
